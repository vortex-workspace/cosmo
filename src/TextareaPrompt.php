...
use Cosmo\Prompt\Concerns\Scrolling;
use Cosmo\Prompt\Concerns\Truncation;
use Cosmo\Prompt\Concerns\TypedValue;
...
class TextareaPrompt extends Prompt
{
    ...
    protected function handleUpKey(): void
    {
        ...
        $lines = Collection::from($this->lines());
    ...
    protected function currentLineIndex(): int
    {
        ...
        return (int) Collection::from($this->lines())->search(function ($line) use (&$totalLineLength) {
