...
use Cosmo\Console\Themes\Contracts\Scrolling as ScrollingRenderer;
...
trait Scrolling
{
     ...
     */
    protected function highlight(?int $index): bool
    {
     ...
     */
    protected function highlightPrevious(int $total, bool $allowNull = false): bool
    {
        if ($total === 0) {
            return true;
        }
     ...
     */
    protected function highlightNext(int $total, bool $allowNull = false): bool
    {
        if ($total === 0) {
            return true;
        }
