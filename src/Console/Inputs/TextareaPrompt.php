...
use Cosmo\Console\Concerns\Scrolling;
use Cosmo\Console\Concerns\Truncation;
...
class TextareaPrompt extends Prompt
{
    ...
    protected function handleUpKey(): void
    {
        ...
        $lines =(new Collection($this->lines()));
    ...
    protected function currentLineIndex(): int
    {
        ...
        return (int) (new Collection($this->lines()))->search(function ($line) use (&$totalLineLength) {
